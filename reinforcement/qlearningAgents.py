...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        features = [feature for feature in featureValues.keys() ]
        for feature in featureValues:
          value += self.weights[feature] * featureValues[feature]
    ...
    def update(self, state, action, nextState, reward):
        ...
        for feature in featureValues:
          self.weights[feature] = self.weights[feature] + self.alpha * diff * featureValues[feature]
